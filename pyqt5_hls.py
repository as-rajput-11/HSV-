...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.verticalSlider.valueChanged['int'].connect(self.Hue_value)
		self.verticalSlider_2.valueChanged['int'].connect(self.Sat_value)
		...
		self.Hue_value_now = 0 # Updated brightness value
		self.Sat_value_now = 0 # Updated blur value
	...
	def Hue_value(self,value):
		""" This function will take value from the slider
			for the brightness from 0 to 180
		"""
	...
	def changeBrightness(self,img,value):
		""" This function will take an image (img) and the Hue
			value. It will perform the Hue change using OpenCv
	...
	def changeBlur(self,img,value):
		""" This function will take the img image and Saturation values as inputs.
			After perform Saturation operation using opencv function, it returns 
			the image img.
		"""
	...
	def update(self):
		...
		"""
		img = self.changeBrightness(self.image,self.Hue_value_now)
		img = self.changeBlur(img,self.Sat_value_now)
		self.setPhoto(img)
